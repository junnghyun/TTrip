...
<%@ page import="kr.co.triptrip.admin.prd.AdminPrdDAO, kr.co.triptrip.admin.prd.AdminPrdVO, kr.co.triptrip.prd.algyingrdnt.AllergyIngredientVO" %>
...
<%
    ...
    // 업로드될 경로를 설정합니다.
    String uploadDirPath = "C:/Users/user/git/model2_project/src/main/webapp/admin_boardlist/common/images";
