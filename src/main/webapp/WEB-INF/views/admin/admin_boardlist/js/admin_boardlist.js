    ...
    fetch(`product_detail.jsp?productId=${productId}`)
        ...
        .then(data => {
			...
			const imagePreview = document.getElementById("imagePreview");
			       if (data.product_img) {
			           imagePreview.src = `http://localhost/model2_project/truetrue/common/images/bread/${data.product_img}`;
			       } else {
			           // 이미지가 없는 경우 기본 이미지 설정
			           imagePreview.src = "http://localhost/model2_project/truetrue/common/images/bread/bread1.jpg";
			       }
