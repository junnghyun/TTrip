...
<%@page import="kr.co.triptrip.user.store.StoreSearchVO"%>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/admin_lodging.css?after">
    <script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
    <script src="js/admin_lodging.js" defer></script>
