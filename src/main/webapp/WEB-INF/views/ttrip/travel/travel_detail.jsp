...
<div class="middle">
<div class="cont">
넓은 공원의 푸른 자연은 마음을 탁 트이게 하고 바쁜 일상에서 놓여나게 한다. 미술 전시관을 둘러보고 여러 가지 프로그램을 통해 미술 공부하는 기회도 갖고, 
자연학습을 체험할 수 있는 안산에서의 하루는 잠시 삶의 여유를 갖게 할 것이다.
안산을 여유롭게 즐기는 방법에 대해서 고심하고 계획한 코스인만큼 많은 이들이 즐겼으면 좋겠는 코스이다.
</div>
...
<div class="detail">
<div class="dayBtnBox">
<input type="button" name="dayBtn" class="dayBtn" value="1일차">
<input type="button" name="dayBtn" class="dayBtn" value="2일차">
<input type="button" name="dayBtn" class="dayBtn" value="3일차">
<input type="button" name="dayBtn" class="dayBtn" value="4일차">
</div>

<div class="imgBox">
<img alt="경기도 미술관" src="/ttrip/travel/images/testImg1.jpg" class="dayImg">
<img alt="상호공원" src="/ttrip/travel/images/testImg2.jpg" class="dayImg">
<img alt="대부호텔" src="/ttrip/travel/images/testImg3.jpg" class="dayImg">
</div>

<div class="imgDetail">
<h2><strong>경기도 미술관</strong></h2>
<span>경기도 안산시 단원구 동산로 268</span><br>
<img alt="경기도 미술관" src="/ttrip/travel/images/testImg1.jpg" class="detailImg">
</div>
