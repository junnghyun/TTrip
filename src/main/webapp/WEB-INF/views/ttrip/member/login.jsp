    ...
    <div class="form login">
        ...
        <div class="media-options">
            <a href="#" class="field kakao">
                <img src="${pageContext.request.contextPath}/ttrip/member/images/kakao_logo.png" alt="Kakao"
                     class="kakao-img">
        ...
        <div class="media-options">
            <a href="#" class="field naver">
                <img src="${pageContext.request.contextPath}/ttrip/member/images/naver_logo.png" alt="Naver"
                     class="naver-img">
