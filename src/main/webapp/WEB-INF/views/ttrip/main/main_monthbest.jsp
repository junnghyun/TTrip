    ...
    <div class="cockcock_planner">
        ...
        <div class="tab">
            <ul>
                ...
                <li id="best" class="on"><a href="monthbest.jsp" onclick="getCurationMainPlannerBestContents(true);">월간Best30</a></li>
                <li id="area" class=""><a href="maintripboard.jsp" onclick="settingRegionPlannerCourse(true);">여행게시판</a></li>
            </ul>
        </div>
